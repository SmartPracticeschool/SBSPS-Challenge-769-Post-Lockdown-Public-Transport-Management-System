...
public class Administrationphase extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administrationphase);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.reg_btn:
                finish();
                Intent i = new Intent(Administrationphase.this, admin_regis.class);
                startActivity(i);
                break;
        ...
        mAuth.signInWithEmailAndPassword(email_input, password_input).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    finish();
                    Intent i = new Intent(Administrationphase.this, administrationphasedashboard.class);
    ...
    protected void onStart() {
        ...
        if (mAuth.getCurrentUser()!=null){
            finish();
            Intent i = new Intent(this,administrationphasedashboard.class);
            startActivity(i);
        }
    }
    }